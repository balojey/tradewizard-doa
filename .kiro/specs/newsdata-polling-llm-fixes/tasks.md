...
- [ ] 4. Write bug condition exploration test for polling agent selection
...
- [ ] 5. Write preservation property tests for other agent selection (BEFORE implementing fix)
...
- [ ] 6. Fix polling agent selection for policy and geopolitical markets

  - [ ] 6.1 Add polling agent to policy and geopolitical market types (Python)
  ...
  - [ ] 6.2 Add polling agent to policy and geopolitical market types (TypeScript)
