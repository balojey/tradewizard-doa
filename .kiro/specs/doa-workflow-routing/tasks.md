...
- [ ] 1. Add workflow service configuration schema
...
- [ ] 2. Implement workflow service HTTP client
  - [ ] 2.1 Create `src/utils/workflow-service-client.ts` file
  ...
  - [ ] 2.2 Implement response validation
  ...
  - [ ] 2.4 Implement createWorkflowServiceClient factory function
...
- [ ] 3. Implement workflow routing logic
  - [ ] 3.1 Refactor analyzeMarket function in `src/workflow.ts`
  ...
  - [ ] 3.2 Implement executeRemoteWorkflow function
  ...
  - [ ] 3.3 Extract existing workflow logic into executeLocalWorkflow function
...
- [ ] 5. Update monitor service for workflow service integration
  - [ ] 5.1 Add workflow service health tracking to monitor service
  ...
  - [ ] 5.2 Update analyzeMarket error handling in monitor service
  ...
  - [ ] 5.3 Update health check endpoint to include workflow service status
...
- [ ] 6. Verify CLI integration
  - [ ] 6.1 Test CLI with workflow service URL configured
  ...
  - [ ] 6.2 Test CLI without workflow service URL
...
- [ ] 7. Integration testing
  - [ ] 7.1 Create integration test for end-to-end workflow service flow
  ...
  - [ ] 7.2 Create integration test for local execution
...
- [ ] 8. Documentation and deployment preparation
  - [ ] 8.1 Update README or deployment docs with workflow service configuration
