...
class PolymarketMarket(BaseModel):
    ...
    question: str
    conditionId: str
    outcomes: str  # JSON string like '["Yes", "No"]'
    outcomePrices: str  # JSON string like "[0.52, 0.48]"
    volume: str
    liquidity: str
    active: bool
    closed: bool
        ...
        for attempt in range(self.max_retries):
            try:
                async with httpx.AsyncClient(timeout=30.0) as client:
                    ...
                    # Extract market from response (could be list or single object)
    ...
    def transform_to_mbd(
        ...
        if market.endDate:
            try:
                ...
                expiry_dt = datetime.fromisoformat(market.endDate.replace('Z', '+00:00'))
